...
The beta branch `guideline-evidence-packs-and-reconstruction-v1` started at `ad6149d992e3ab6dd5e638411165b2feb5a125f3`. The original implementation commit `71c0a6606d80b61295d2ddb9ba1316e449464383` was subsequently corrected by the beta-engine and exclusion-scope changes recorded in the final deployment commit. The final deployment record is added after the beta-only GitHub Pages run; stable production and `main` remain untouched.
...
- Live Playwright verification is rerun after the final beta deployment and is recorded in the deployment report. It must show the same counts (1,500/416/1,084/6,290/75,484), zero obsolete dataset requests, and no console errors or failed static assets.
