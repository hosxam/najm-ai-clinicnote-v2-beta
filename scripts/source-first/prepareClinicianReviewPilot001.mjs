...
function workflowPacket(entry, workflow, research, items, proposals) {
  ...
  return `# Qualified-clinician review packet: ${entry.workflow_title}\n\n` +
    ...
    `## Authority boundary\n\nThis packet is generated for qualified-clinician review. Nothing in it is approved or suitable for production use. It makes no autonomous treatment recommendation, invents no dose or diagnosis, and does not expand beyond cited evidence. No decision is preselected.\n\n` +
