...
const hash = value => {
  // Fingerprints are intentionally regenerated by the existing canonical builders.
  // Keep enrichment deterministic and leave existing fingerprints for the builders.
  return value
}
