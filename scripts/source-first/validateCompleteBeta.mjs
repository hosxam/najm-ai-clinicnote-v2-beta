...
async function main() {
  ...
  const errors = []
if (source.counts.original_workflows !== 1500 || source.counts.active_workflows !== 417 || source.counts.inactive_workflows !== 1083) errors.push('source catalogue counts failed')
if (interactive.counts.workflows !== 417 || interactive.counts.fields <= interactive.counts.workflows || interactive.counts.evidence_records_retained !== 75512) errors.push('interactive manifest counts failed')
