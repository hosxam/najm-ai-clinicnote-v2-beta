...
const workflows = [
  ...
  geri({
    ...
    evidence_groups: [
      ...
      { source_id: 'nice-medicines-optimisation-ng5-2015', source_section_id: 'nice-ng5-person-involvement', relationship: 'The exact section supports documenting desired involvement, values, preferences, benefits and harms in a medicines discussion.', exact_texts: ['patient concerns or goals documented if discussed', 'patient questions documented if discussed'] },
    ],
  ...
  geri({
    ...
    evidence_groups: [
      ...
      { source_id: 'nice-multimorbidity-ng56-2016', source_section_id: 'nice-ng56-priorities-goals', relationship: 'The exact section supports personal goals, independence, social participation, carer involvement and clinician-entered planning.', exact_texts: ['patient concerns or goals documented if discussed', 'Caregiver or care-home records reviewed if available', ...plan] },
    ],
  ...
  geri({
    ...
    evidence_groups: [
      ...
      { source_id: 'doh-osteoporosis-screening-v09-2019', source_section_id: 'doh-osteoporosis-2019-fracture-risk', relationship: 'The exact section supports clinician-reviewed fracture-risk, falls and BMD context plus completed functional assessment without auto-calculating FRAX.', exact_texts: [...exam, 'Falls/cognition/function screen results documented if completed'] },
  ...
  geri({
    ...
    evidence_groups: [
      ...
      { source_id: 'nice-multimorbidity-ng56-2016', source_section_id: 'nice-ng56-treatment-review', relationship: 'The exact section supports clinician-led review of benefit, harm, treatment burden and personal priorities plus documented plan and follow-up without generating a change.', exact_texts: ['patient concerns or goals documented if discussed', ...plan] },
    ],
  ...
  geri({
    ...
    evidence_groups: [
      ...
      { source_id: 'nice-multimorbidity-ng56-2016', source_section_id: 'nice-ng56-identification-function-frailty', relationship: 'The exact section supports clinician-assessed function, frailty, falls, gait and support-service burden after discharge.', exact_texts: [...exam, 'Falls/cognition/function screen results documented if completed'] },
      { source_id: 'nice-multimorbidity-ng56-2016', source_section_id: 'nice-ng56-priorities-goals', relationship: 'The exact section supports goals, treatment burden, carer involvement, clinician-entered plan, follow-up and questions.', exact_texts: ['patient concerns or goals documented if discussed', ...plan] },
    ],
