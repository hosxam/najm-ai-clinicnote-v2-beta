...
const workflows = [
  ...
  reviewed({
    ...
    evidence_groups: [
      ...
      { source_id: 'nice-older-people-wellbeing-ng32-2015', source_section_id: 'nice-ng32-risk-isolation-decline', relationship: 'The exact section supports documenting age-related vision impairment, driving cessation, living circumstances and social impact without generating ophthalmic management.', exact_texts: ['severity/impact on function documented if discussed', 'patient concerns or goals documented if discussed', ...plan] },
    ],
  ...
  reviewed({
    ...
    evidence_groups: [
      ...
      { source_id: 'nice-multimorbidity-ng56-2016', source_section_id: 'nice-ng56-priorities-goals', relationship: 'The exact section supports personal goals, independence, social participation, carer involvement and clinician-entered follow-up documentation.', exact_texts: ['patient concerns or goals documented if discussed', 'Caregiver or care-home records reviewed if available', ...plan] },
    ],
