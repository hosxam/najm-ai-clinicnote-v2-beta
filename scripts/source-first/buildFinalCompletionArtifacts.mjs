...
write('FINAL_EVIDENCE_PACKS.json', { schema_version: '1.0.0', active_pack_count: activeCatalog.length, inactive_pack_count: records.length, complete_active_packs: activeCatalog.filter((record) => record.usable).length, inactive_fail_closed_packs: records.length, evidence_pack_ids_present: activeCatalog.reduce((n, record) => n + (record.evidence_pack_ids?.length ?? 0), 0), guideline_family_packs: 1198, guideline_family_packs_complete: 243, guideline_family_packs_terminal_fail_closed: 955, guideline_family_packs_pending: 0, source_grounded_active_catalogue: true, unsupported_inactive_records_have_no_schema: true })
