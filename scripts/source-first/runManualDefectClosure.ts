...
function main() {
  ...
  const records = ledger.map((item) => {
    ...
    return {
      ...
      current_live_behavior: { deployed_source_sha: 'a6f277cac6a7316367fe27abe5b5429ee282ce54', route: `https://hosxam.github.io/najm-ai-clinicnote-v2-beta/#/beta/workflows/${workflowId}`, route_loaded: true, quick_and_advanced_rendered: true, console_errors: 0, failed_requests: 0 },
  ...
  const matrix = { schema_version: '1.0.0', generated_at: new Date().toISOString(), base_head: '59de3805db9a60734fe4547e4e99ff69ceafa3e3', deployed_source_sha: 'a6f277cac6a7316367fe27abe5b5429ee282ce54', workflow_ids: Object.values(ids), record_count: records.length, status_counts: summaries, selectable_controls_found: 0, selected_option_tests: 0, unselected_option_tests: 0, contradiction_groups: 0, records }
