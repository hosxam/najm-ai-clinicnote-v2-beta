...
for (const entry of report.assessments) {
  if (!entry.research_integrity.individually_reassessed || !entry.assessment.search_queries_used.length) throw new Error(`Incomplete reassessment: ${entry.workflow_id}`)
