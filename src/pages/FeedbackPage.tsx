    ...
    <div className="grid gap-6 lg:gap-7 lg:grid-cols-2">
      ...
      >
        <div className="space-y-4 text-sm leading-6 text-slate-700">
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-200 bg-cyan-50 px-3 py-1.5 text-xs font-medium text-cyan-900">
            <ClipboardCheck className="h-3.5 w-3.5 text-cyan-800" />
            One feedback entry per workflow and mode
          </div>
          <p>Record one feedback entry per workflow and mode tested.</p>
          <ul className="list-disc space-y-2.5 pl-5 text-slate-600">
      ...
      >
        <ul className="list-disc space-y-2.5 pl-5 text-sm leading-6 text-slate-700">
          <li className="marker:text-amber-600">Use mock or anonymized cases only.</li>
